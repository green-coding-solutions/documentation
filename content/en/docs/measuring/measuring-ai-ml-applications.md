...
This contains a [usage scenario to run on the CPU only](https://github.com/green-coding-solutions/example-applications/blob/main/ai-model/usage_scenario.yml) and one
